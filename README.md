...
* i maintain [Dink](https://github.com/pajlads/DinkPlugin/), a [RuneLite](https://github.com/runelite/runelite/) plugin that calls webhooks upon in-game events (70K weekly users)
* i maintain [Pickpocket Helper](https://github.com/pajlads/runelite-pickpocket-helper), a [RuneLite](https://github.com/runelite/runelite/) plugin that faciliates thieving in OSRS (60K weekly users)
